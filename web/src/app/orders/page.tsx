  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-10">
      <div className="text-center mb-10">
        ...
        <p className="text-gray-500 text-sm">Enter your phone number to view all your orders</p>
      </div>
      ...
      <div className="bg-warm-white rounded-sm p-6 mb-8">
        <div className="flex gap-3">
          ...
          <button
            onClick={fetchOrders}
            disabled={loading}
            className="btn-primary px-6 py-2.5 self-end text-sm disabled:opacity-50"
          >
            {loading ? '...' : 'View Orders'}
          </button>
        </div>
      ...
      {searched && orders.length === 0 && (
        <div className="text-center py-12 text-gray-400">
          ...
          <p className="text-sm mt-1">We couldn&apos;t find any orders for this number.</p>
            ...
            return (
              <div key={order.id} className="bg-white border border-gray-100 rounded-sm p-5 shadow-sm">
                ...
                <div className="border-t pt-3 flex items-center justify-between">
                  ...
                  <Link href={`/order/${order.id}`} className="text-sm text-rose-gold hover:underline font-medium">
                    View Details →
                  </Link>
                </div>
