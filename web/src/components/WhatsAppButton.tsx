...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className={`fixed z-50 w-12 h-12 flex items-center justify-center rounded-full transition-all duration-300
        bottom-[88px] right-4 md:bottom-8 md:right-6
        ${bounced ? 'animate-whatsapp-bounce' : 'scale-0 opacity-0'}`}
      style={{
