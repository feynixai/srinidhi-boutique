...
export function NewsletterSignup() {
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 py-10">
      <div className="bg-white/60 backdrop-blur-xl border border-white/40 rounded-3xl shadow-card py-14 px-6">
        <div className="max-w-2xl mx-auto text-center">
          <p className="text-[#c5a55a] uppercase tracking-[0.25em] text-xs font-semibold mb-2">Stay in the Loop</p>
          <h2 className="font-serif text-3xl text-[#1a1a2e] mb-2">Join Our Community</h2>
          ...
          {subscribed ? (
            ...
            <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 max-w-lg mx-auto">
              <input
                ...
                className="flex-1 border border-white/50 bg-white/70 backdrop-blur-sm px-4 py-3 rounded-full text-sm focus:outline-none focus:border-[#c5a55a] text-[#1a1a2e] placeholder:text-[#1a1a2e]/40"
              />
              <input
                type="email"
                value={email}
                ...
                required
                className="flex-[1.5] border border-white/50 bg-white/70 backdrop-blur-sm px-4 py-3 rounded-full text-sm focus:outline-none focus:border-[#c5a55a] text-[#1a1a2e] placeholder:text-[#1a1a2e]/40"
              />
              <button
                type="submit"
                disabled={loading}
          ...
          <p className="text-[#1a1a2e]/30 text-xs mt-4">No spam, ever. Unsubscribe anytime.</p>
        </div>
      </div>
    </section>
  );
