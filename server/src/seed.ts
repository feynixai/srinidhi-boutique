...
async function main() {
  ...
  const products = [
    // Sarees
    {
      ...
      description: 'Pure Kanjivaram silk saree with intricate gold zari work. Perfect for weddings and festive occasions. Comes with matching blouse piece.',
      price: 12500,
      comparePrice: 15000,
      images: [
    ...
    },
    {
      ...
      description: 'Elegant Banarasi georgette saree with subtle silver border. Lightweight and comfortable for all-day wear.',
      price: 4200,
      comparePrice: 5500,
      images: [
    ...
    },
    {
      ...
      description: 'Handwoven cotton saree in soft pastel pink. Breathable fabric ideal for daily wear and casual events.',
      price: 1800,
      comparePrice: null,
      images: [
    ...
    },
    {
      ...
      description: 'Shimmery chiffon saree with sequin border. A showstopper for evening parties and receptions.',
      price: 3500,
      comparePrice: 4200,
      images: [
        'https://picsum.photos/seed/saree4/600/800',
      ],
      categoryId: sarees.id,
      sizes: ['Free Size'],
    ...
    },
    {
      ...
      description: 'Lightweight linen saree in warm earthy tones. Perfect for office wear and casual outings.',
      price: 2200,
      comparePrice: null,
      images: [
        'https://picsum.photos/seed/saree5/600/800',
      ],
      categoryId: sarees.id,
      sizes: ['Free Size'],
      colors: ['Tan', 'Brown'],
    ...
    // Kurtis
    {
      ...
      description: 'Floor-length anarkali kurti with floral print. Comes with palazzo pants. A festive favourite.',
      price: 1599,
      comparePrice: 2000,
      images: [
    ...
    },
    {
      ...
      comparePrice: null,
      images: [
        'https://picsum.photos/seed/kurti2/600/800',
      ],
      categoryId: kurtis.id,
      sizes: ['S', 'M', 'L', 'XL'],
      colors: ['Indigo', 'White'],
    ...
    },
    {
      ...
      comparePrice: 2800,
      images: [
        'https://picsum.photos/seed/kurti3/600/800',
      ],
      categoryId: kurtis.id,
      sizes: ['S', 'M', 'L', 'XL', 'XXL'],
      colors: ['Crimson', 'Gold'],
    ...
    },
    {
      ...
      comparePrice: null,
      images: [
        'https://picsum.photos/seed/kurti4/600/800',
      ],
      categoryId: kurtis.id,
      sizes: ['S', 'M', 'L', 'XL', 'XXL'],
      colors: ['Lavender'],
    ...
    },
    {
      ...
      description: 'Vibrant kurti with traditional mirror work embellishments. Rajasthani art meets modern silhouette.',
      price: 1299,
      comparePrice: 1600,
      images: [
        'https://picsum.photos/seed/kurti5/600/800',
      ],
      categoryId: kurtis.id,
      sizes: ['S', 'M', 'L', 'XL'],
    ...
    // Lehengas
    {
      ...
      description: 'Heavily embroidered bridal lehenga in scarlet red with zari work. Comes with dupatta and blouse piece. A dream for the modern bride.',
      price: 28000,
      comparePrice: 35000,
      images: [
    ...
    },
    {
      ...
      description: 'Light-weight festive lehenga with floral embroidery. Perfect for mehendi and haldi ceremonies.',
      price: 8500,
      comparePrice: 10000,
      images: [
    ...
    },
    {
      ...
      description: 'Shimmer party lehenga in rose gold with sequin work. A perfect choice for cocktail parties and receptions.',
      price: 5500,
      comparePrice: 6500,
      images: [
    ...
    // Blouses
    {
      ...
      comparePrice: 2200,
      images: [
        'https://picsum.photos/seed/blouse1/600/800',
      ],
    ...
    },
    {
      ...
      description: 'Trendy backless blouse in navy with pearl buttons. Adds a contemporary touch to traditional sarees.',
      price: 1200,
      comparePrice: null,
      images: [
        'https://picsum.photos/seed/blouse2/600/800',
      ],
      categoryId: blouses.id,
      sizes: ['XS', 'S', 'M', 'L', 'XL'],
      colors: ['Navy Blue'],
    ...
    },
    {
      ...
      comparePrice: 1200,
      images: [
        'https://picsum.photos/seed/blouse3/600/800',
      ],
      categoryId: blouses.id,
      sizes: ['S', 'M', 'L', 'XL'],
      colors: ['Multicolor'],
    ...
    // Accessories
    {
      ...
      description: 'Traditional temple jewellery set including necklace, earrings, and maang tikka. Perfect for bridal and festive look.',
      price: 3200,
      comparePrice: 4000,
      images: [
    ...
    },
    {
      ...
      description: 'Hand-embroidered silk potli bag. The perfect ethnic accessory to complete your traditional outfit.',
      price: 599,
      comparePrice: 799,
      images: [
