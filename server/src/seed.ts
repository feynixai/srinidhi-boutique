...
async function main() {
  ...
  const products = [
    ...
    // --- Additional Products ---
    {
      ...
      description: 'Pure Tussar silk saree in natural gold with contrast pallu. Lightweight and perfect for pujas and festive occasions. Handwoven by artisans from Bhagalpur.',
      price: 5999,
      comparePrice: 7499,
      images: ['https://picsum.photos/seed/tussar1/600/800', 'https://picsum.photos/seed/tussar2/600/800'],
      categoryId: sarees.id,
      sizes: ['Free Size'],
      colors: ['Natural Gold', 'Beige'],
      fabric: 'Tussar Silk',
      occasion: ['festival', 'puja', 'casual'],
      stock: 12,
      featured: false,
      bestSeller: true,
      onOffer: false,
    ...
    {
      name: 'Linen Blend Saree - Sage Green',
      description: 'Contemporary linen blend saree in calming sage green. Silver zari border adds a touch of elegance. Ideal for office wear and casual outings. Easy to drape and maintain.',
      price: 2999,
      images: ['https://picsum.photos/seed/linen1/600/800', 'https://picsum.photos/seed/linen2/600/800'],
      categoryId: sarees.id,
      sizes: ['Free Size'],
      colors: ['Sage Green', 'Silver'],
      fabric: 'Linen Blend',
    ...
    {
      name: 'Palazzo Kurta Set - Ivory White',
      description: 'Elegant ivory white palazzo kurta set with delicate thread embroidery on the yoke. Includes matching palazzo pants and chiffon dupatta. Perfect for brunches and festive gatherings.',
      price: 2799,
      comparePrice: 3499,
      images: ['https://picsum.photos/seed/palazzo1/600/800', 'https://picsum.photos/seed/palazzo2/600/800'],
      categoryId: kurtis.id,
      sizes: ['S', 'M', 'L', 'XL', 'XXL'],
    ...
    {
      name: 'Printed Rayon Kurti - Indigo Block',
      description: 'Hand block printed rayon kurti in rich indigo. Traditional Rajasthani ajrakh print with contrast piping. Comfortable A-line silhouette for everyday wear.',
      price: 1199,
      images: ['https://picsum.photos/seed/indigo1/600/800', 'https://picsum.photos/seed/indigo2/600/800'],
      categoryId: kurtis.id,
      sizes: ['S', 'M', 'L', 'XL'],
      colors: ['Indigo', 'White'],
      fabric: 'Rayon',
    ...
    {
      name: 'Mirror Work Chaniya Choli - Turquoise',
      description: 'Vibrant turquoise chaniya choli set with traditional mirror work from Gujarat. Includes flared skirt, fitted blouse, and bandhani dupatta. Made for Navratri and garba nights.',
      price: 4499,
      comparePrice: 5999,
      images: ['https://picsum.photos/seed/mirror1/600/800', 'https://picsum.photos/seed/mirror2/600/800'],
      categoryId: lehengas.id,
      sizes: ['S', 'M', 'L', 'XL'],
      colors: ['Turquoise', 'Gold'],
      fabric: 'Cotton Silk',
      occasion: ['navratri', 'festival', 'party'],
      stock: 8,
      featured: true,
      bestSeller: false,
      onOffer: true,
    ...
    {
      name: 'Net Lehenga Skirt - Peach',
      description: 'Delicate peach net lehenga skirt with sequin and thread embroidery. Can be paired with any crop top or blouse for a modern fusion look. Fully lined with cancan for volume.',
      price: 3999,
      images: ['https://picsum.photos/seed/net1/600/800', 'https://picsum.photos/seed/net2/600/800'],
      categoryId: lehengas.id,
      sizes: ['S', 'M', 'L'],
      colors: ['Peach', 'Rose Gold'],
      fabric: 'Net',
      occasion: ['party', 'wedding', 'sangeet'],
      stock: 6,
      featured: false,
      bestSeller: false,
      onOffer: false,
    ...
    {
      name: 'Padded Silk Blouse - Navy Blue',
      description: 'Ready-to-wear padded silk blouse in deep navy blue with gold piping. Princess cut for a flattering fit. Back hook closure. Pairs beautifully with contrast sarees.',
      price: 1299,
      images: ['https://picsum.photos/seed/navy1/600/800', 'https://picsum.photos/seed/navy2/600/800'],
      categoryId: blouses.id,
      sizes: ['32', '34', '36', '38', '40'],
    ...
    {
      name: 'Ikat Print Cotton Blouse - Red',
      description: 'Handloom ikat print cotton blouse in vibrant red and white. Round neck, short sleeves, back button closure. Perfect with plain sarees and palazzo sets.',
      price: 799,
      images: ['https://picsum.photos/seed/ikat1/600/800', 'https://picsum.photos/seed/ikat2/600/800'],
      categoryId: blouses.id,
      sizes: ['32', '34', '36', '38', '40'],
      colors: ['Red', 'White'],
    ...
    },
    {
      ...
      description: 'Elegant freshwater pearl choker necklace with matching jhumka earrings. Gold-plated brass setting. Adjustable chain for comfortable fit. Perfect for sarees and lehengas.',
      price: 1999,
      images: ['https://picsum.photos/seed/pearl1/600/800', 'https://picsum.photos/seed/pearl2/600/800'],
      categoryId: accessories.id,
      sizes: ['Free Size'],
    ...
    },
    {
      ...
      description: 'Traditional kundan maang tikka with pearls and green meenakari work. Gold-plated with adjustable hook. A must-have for bridal and festive looks.',
      price: 699,
      images: ['https://picsum.photos/seed/tikka1/600/800', 'https://picsum.photos/seed/tikka2/600/800'],
      categoryId: accessories.id,
      sizes: ['Free Size'],
      colors: ['Gold', 'Green'],
      fabric: 'Kundan Stone',
    ...
    {
      name: 'Banarasi Brocade Dupatta - Magenta',
      description: 'Rich Banarasi brocade dupatta in deep magenta with gold zari weave. Adds instant glam to any plain kurta or lehenga. Handcrafted in Varanasi.',
      price: 1899,
      comparePrice: 2499,
      images: ['https://picsum.photos/seed/brocade1/600/800', 'https://picsum.photos/seed/brocade2/600/800'],
      categoryId: accessories.id,
      sizes: ['Free Size'],
      colors: ['Magenta', 'Gold'],
    ...
    {
      name: 'Khadi Cotton Kurti - Mustard',
      description: 'Sustainable khadi cotton kurti in warm mustard yellow. Hand-spun fabric with wooden button detailing. Relaxed fit, perfect for everyday wear. Supporting Indian weavers.',
      price: 1499,
      images: ['https://picsum.photos/seed/khadi1/600/800', 'https://picsum.photos/seed/khadi2/600/800'],
      categoryId: kurtis.id,
      sizes: ['S', 'M', 'L', 'XL', 'XXL'],
    ...
    {
      name: 'Velvet Blouse - Wine',
      description: 'Luxurious velvet blouse in deep wine colour with gold embroidered sleeves. Sweetheart neckline with padded cups. Ideal for winter weddings and receptions.',
      price: 2199,
      images: ['https://picsum.photos/seed/velvet1/600/800', 'https://picsum.photos/seed/velvet2/600/800'],
      categoryId: blouses.id,
      sizes: ['32', '34', '36', '38'],
      colors: ['Wine', 'Gold'],
      fabric: 'Velvet',
    ...
    {
      name: 'Sharara Set - Emerald Green',
      description: 'Stunning emerald green sharara set with gota patti work. Includes short kurti, wide-leg sharara pants, and net dupatta. A showstopper for mehendi and sangeet functions.',
      price: 7999,
      comparePrice: 9999,
      images: ['https://picsum.photos/seed/sharara1/600/800', 'https://picsum.photos/seed/sharara2/600/800'],
      categoryId: lehengas.id,
      sizes: ['S', 'M', 'L', 'XL'],
      colors: ['Emerald Green', 'Gold'],
      fabric: 'Georgette',
      occasion: ['wedding', 'sangeet', 'party'],
      stock: 5,
      featured: true,
      bestSeller: false,
      onOffer: true,
    ...
    },
    {
      ...
      description: 'Traditional South Indian temple jewellery necklace set with matching jhumkas. Antique gold finish with ruby and emerald stones. Statement piece for silk sarees.',
      price: 3499,
      images: ['https://picsum.photos/seed/temple1/600/800', 'https://picsum.photos/seed/temple2/600/800'],
      categoryId: accessories.id,
      sizes: ['Free Size'],
      colors: ['Antique Gold', 'Ruby Red'],
    ...
    {
      name: 'Georgette Saree - Lavender',
      description: 'Flowing georgette saree in soft lavender with delicate sequin border. Lightweight and easy to drape. Comes with unstitched blouse piece. Perfect for cocktail parties and evening events.',
      price: 3499,
      comparePrice: 4499,
      images: ['https://picsum.photos/seed/lavender1/600/800', 'https://picsum.photos/seed/lavender2/600/800'],
      categoryId: sarees.id,
      sizes: ['Free Size'],
    ...
    {
      name: 'Embroidered Jacket Kurti - Olive',
      description: 'Trendy olive green kurti with attached embroidered jacket. Three-quarter sleeves with mandarin collar. Perfect fusion look for work and casual outings.',
      price: 1799,
      images: ['https://picsum.photos/seed/jacket1/600/800', 'https://picsum.photos/seed/jacket2/600/800'],
      categoryId: kurtis.id,
      sizes: ['S', 'M', 'L', 'XL'],
    ...
    },
    {
      ...
      description: 'Statement oxidised silver jhumka earrings with traditional Rajasthani mirror work. Lightweight despite their size. Goes with everything from kurtis to sarees.',
      price: 599,
      images: ['https://picsum.photos/seed/oxidised1/600/800', 'https://picsum.photos/seed/oxidised2/600/800'],
      categoryId: accessories.id,
      sizes: ['Free Size'],
      colors: ['Oxidised Silver'],
      fabric: 'German Silver',
      occasion: ['casual', 'festival', 'college'],
      stock: 40,
      featured: false,
      bestSeller: true,
      onOffer: false,
    ...
    {
      name: 'Silk Pajama Kurta Set - Powder Blue',
      description: 'Elegant powder blue silk pajama kurta set with minimal gold embroidery. Comfortable straight-cut kurta with matching silk pajama pants. Great for festive dinners and Eid celebrations.',
      price: 3299,
      images: ['https://picsum.photos/seed/pajama1/600/800', 'https://picsum.photos/seed/pajama2/600/800'],
      categoryId: kurtis.id,
      sizes: ['S', 'M', 'L', 'XL', 'XXL'],
