...
export function WhatsAppButton() {
  ...
  const href = `https://wa.me/${number}?text=${encodeURIComponent('Hi! I need help with Srinidhi Boutique.')}`;
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 w-14 h-14 bg-green-500 text-white rounded-full shadow-lg flex items-center justify-center hover:bg-green-600 transition-colors"
